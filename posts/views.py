...
def post_detail(request, pk):
    """Create a view that returns a single post object based on the post ID (pk) and render it the 'postdetail.html' template. Or return a 404 error if the post is not found"""
